    ...
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="text-center mt-2">
          ...
          <span class="d-inline-block">あなたのお店の名前でShopIDを作成してください</span>
        </div>
        <div class="card-body">
          <form method="POST" action="{{ route('shops.store') }}">
            @csrf
            <div class="form-group row">
              <label for="name" class="col-md-4 col-form-label text-md-right">ショップネーム</label>
              <div class="col-md-6">
                <input id="text" class="form-control @error('name') is-invalid @enderror" name="name"
                  value="{{ old('name') }}" placeholder="10文字以内" required autocomplete="off" autofocus>
                @error('name')
